...
public class DHCPv6Explorer { // Port 546
    ...
    public DHCPv6Explorer(int interfaceId, String hardwareAddress) throws UnknownHostException {
        InetAddress inetAddress = Inet6Address.getByAddress("", hexStringtoByteArray(All_DHCP_RELAY_AGENTS_AND_SERVERS), interfaceId);
        ...
        message.append(String.format("%04x", hardwareAddress.length() / 2 + 2 + 2)); // option-len: Length of DUID in octets.
        ...
        message.append(hardwareAddress);
